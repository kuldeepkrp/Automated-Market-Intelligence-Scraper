...
Installation: Installs necessary libraries.
Imports: Imports requests, BeautifulSoup, and pandas.
Web Scraping: Code to fetch the webpage and extract initial data.
Data Cleaning & Transformation: Steps to clean prices, convert to INR, and create Is_Available status.
Market Analysis: Computes average prices per star rating.
Visualisations: Generates various plots to display findings.
Export Data: Saves the processed data and summary to an Excel file.
Analysis Highlights
